  ...
  return (
    <main className="min-h-[70vh] bg-[#FFFDF8] px-6 py-16">
      <div className="mx-auto max-w-md rounded-2xl border border-[#E7D8C3] bg-white p-8 shadow-sm">
        <p className="text-sm font-semibold uppercase tracking-[4px] text-[#8B5A2B]">Join us</p>
        <h1 className="mt-2 text-3xl font-bold text-[#5A3A1B]">Create account</h1>
        <p className="mt-2 text-gray-600">Save your details for a smoother shopping experience.</p>
        ...
        <p className="mt-6 text-center text-sm text-gray-600">
          ...
          <Link href="/login" className="font-medium text-[#8B5A2B] underline">
            Sign in
          </Link>
        </p>
      </div>
